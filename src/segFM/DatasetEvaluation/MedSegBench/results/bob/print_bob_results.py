...
def main():
    ...
    csv_path = os.path.join(current_dir, 'MedSegBench.csv')
    
    # Read the CSV file
    try:
        df = pd.read_csv(csv_path)
        print(f"Successfully loaded {len(df)} rows from FLARE22.csv")
    except FileNotFoundError:
        print(f"Error: FLARE22.csv not found in {current_dir}")
        return
    ...
    target_objects = [
        ...
        "heart_atrium_left", "Glottis", "Left Vocal Cord", "Right Vocal Cord", "Lung", "Neoplastic Polyp",
        "Liver","Right Kidney", "Spleen", "Mitochondria", "Aorta", "Inferior Vena Cava", "Pharynx",
        "Fetal Head", "Gallbladder", "Esophagus", "Stomach", "Tooth", "Left Kidney", "Prostate/Uterus",
        "Prostate", "Skin Lesion", "Glioma", "Optic Disc", "Optic Cup", "Nucleus", "Heart Myocardium",
        "Heart Left Ventricle", "Heart Right Ventricle", "Heart Atrium Left"
    ]
