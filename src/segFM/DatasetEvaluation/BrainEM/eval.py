...
PROMPT_FINDER = "random"  # "random", "BOB D-FINE-N"
...
#     postprocessing=True,
# )
sam_predictor = SAM3ImageSegmenter(mode="box")

# Evaluate the model's performance on a large number of images
df = sam_predictor.evaluate_model(dataset=dataset, n_images=N_IMAGES, plot_results=True)
